...
class TaskTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Map.TaskTableMap';
     ...
     */
    const OM_CLASS = '\\AppBundle\\Model\\Task';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Task';
    ...
    /**
     * the column name for the descryption field
     */
    const COL_DESCRYPTION = 'task.descryption';

    /**
     * the column name for the start_date field
     */
    const COL_START_DATE = 'task.start_date';

    /**
     * the column name for the end_date field
     */
    const COL_END_DATE = 'task.end_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Descryption', 'StartDate', 'EndDate', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'descryption', 'startDate', 'endDate', ),
        self::TYPE_COLNAME       => array(TaskTableMap::COL_ID, TaskTableMap::COL_NAME, TaskTableMap::COL_DESCRYPTION, TaskTableMap::COL_START_DATE, TaskTableMap::COL_END_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'descryption', 'start_date', 'end_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Descryption' => 2, 'StartDate' => 3, 'EndDate' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'descryption' => 2, 'startDate' => 3, 'endDate' => 4, ),
        self::TYPE_COLNAME       => array(TaskTableMap::COL_ID => 0, TaskTableMap::COL_NAME => 1, TaskTableMap::COL_DESCRYPTION => 2, TaskTableMap::COL_START_DATE => 3, TaskTableMap::COL_END_DATE => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'descryption' => 2, 'start_date' => 3, 'end_date' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\AppBundle\\Model\\Task');
        $this->setPackage('src');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 128, null);
        $this->addColumn('descryption', 'Descryption', 'VARCHAR', true, 128, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TaskTableMap::COL_DESCRYPTION);
            $criteria->addSelectColumn(TaskTableMap::COL_START_DATE);
            $criteria->addSelectColumn(TaskTableMap::COL_END_DATE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.descryption');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \AppBundle\Model\Task) { // it's a model object
